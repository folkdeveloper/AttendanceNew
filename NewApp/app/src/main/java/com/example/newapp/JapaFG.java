...
public class JapaFG extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_japa_fg);
...
//        mTextView.setText(japa + "      " + spinSessions + "      " + tl);
    }
                    ...
                    .addSnapshotListener(new EventListener<QuerySnapshot>() {
                        ...
                        public void onEvent(@Nullable QuerySnapshot queryDocumentSnapshots, @Nullable FirebaseFirestoreException e) {
                            ...
                            for (QueryDocumentSnapshot documentSnapshot : queryDocumentSnapshots) {
                                ...
                                Log.d(TAG, "onEvent: Japa" + note.getFg());
                            ...
                            mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                ...
                                public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                                    ...
                                    Intent intent = new Intent(JapaFG.this, JapaDetails.class);
