...
public class OrganizationActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
                        ...
                        fgboys
                                ...
                                .addSnapshotListener(new EventListener<QuerySnapshot>() {
                                    ...
                                    public void onEvent(@Nullable QuerySnapshot queryDocumentSnapshots, @Nullable FirebaseFirestoreException e) {
                                        ...
                                        for (QueryDocumentSnapshot documentSnapshot : queryDocumentSnapshots) {
                                            Note note = documentSnapshot.toObject(Note.class);
                                            if (count.containsKey(note.getOrganization())) {
                                                int number = count.get(note.getOrganization());
                                                number++;
                                                total2++;
                                                count.put(note.getOrganization(), number);
                                                count.put("ALL", total2);
                                            } else {
                                                total2++;
                                                count.put(note.getOrganization(), 1);
                                                count.put("ALL", total2);
                                            }
                                        }
                                        ...
                                        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                            ...
                                            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                                                ...
                                                Intent intent = new Intent(OrganizationActivity.this, OrganizationDetails.class);
...
//                            Toast.makeText(MainActivity.this, spinnerText, Toast.LENGTH_SHORT).show();
    ...
    public void select1(View v) {
        Intent intent = new Intent(OrganizationActivity.this, DateSelector.class);
        startActivity(intent);
    }
}