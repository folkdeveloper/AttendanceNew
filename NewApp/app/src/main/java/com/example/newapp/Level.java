...
public class Level extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
                                    ...
                                    public void onEvent(@Nullable QuerySnapshot queryDocumentSnapshots, @Nullable FirebaseFirestoreException e) {
                                        ...
                                        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                            ...
                                            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                                                ...
                                                Intent intent = new Intent(Level.this, LevelsFG.class);
...
//                                .whereEqualTo("zzdate", date)
    ...
    public void select1(View v) {
        Intent intent = new Intent(Level.this, DateSelector.class);
        startActivity(intent);
    }
