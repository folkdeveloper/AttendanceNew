...
public class DateSelectorReg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_date_selector_reg);
...
//                        R.style.Theme_AppCompat_DayNight_Dialog,
    ...
    public void select1(View v) {
        if (date1.equals("")) {
            ...
            Intent intent = new Intent(DateSelectorReg.this, MainActivity.class);
    ...
    public void select2(View v) {
        if (date1.equals("")) {
            ...
            Intent intent = new Intent(DateSelectorReg.this, AreaActivity.class);
            Bundle bundle = new Bundle();
            bundle.putLong("Date1",epoch1);
            bundle.putLong("Date2",epoch2);
            bundle.putString("Collection",collection);
    ...
    public void select3(View v) {
        if (date1.equals("")) {
            ...
            Intent intent = new Intent(DateSelectorReg.this, Level.class);
            Bundle bundle = new Bundle();
            bundle.putLong("Date1",epoch1);
            bundle.putLong("Date2",epoch2);
            bundle.putString("Collection",collection);
    ...
    public void select4(View v) {
        if (date1.equals("")) {
            ...
            Intent intent = new Intent(DateSelectorReg.this, TurnoutActivity.class);
            Bundle bundle = new Bundle();
            bundle.putLong("Date1",epoch1);
            bundle.putLong("Date2",epoch2);
            bundle.putString("Collection",collection);
    ...
    public void select5(View v) {
        if (date1.equals("")) {
            ...
            Intent intent = new Intent(DateSelectorReg.this, OccupationActivity.class);
            Bundle bundle = new Bundle();
            bundle.putLong("Date1",epoch1);
            bundle.putLong("Date2",epoch2);
            bundle.putString("Collection",collection);
    ...
    public void select6(View v) {
        if (date1.equals("")) {
            ...
            Intent intent = new Intent(DateSelectorReg.this, JapaActivity.class);
            Bundle bundle = new Bundle();
            bundle.putLong("Date1",epoch1);
            bundle.putLong("Date2",epoch2);
            bundle.putString("Collection",collection);
    ...
    public void select7(View v) {
        if (date1.equals("")) {
            ...
            Intent intent = new Intent(DateSelectorReg.this, BranchActivity.class);
            Bundle bundle = new Bundle();
            bundle.putLong("Date1",epoch1);
            bundle.putLong("Date2",epoch2);
            bundle.putString("Collection",collection);
    ...
    public void select8(View v) {
        if (date1.equals("")) {
            ...
            Intent intent = new Intent(DateSelectorReg.this, OrganizationActivity.class);
            Bundle bundle = new Bundle();
            bundle.putLong("Date1",epoch1);
            bundle.putLong("Date2",epoch2);
            bundle.putString("Collection",collection);
    ...
    public void select9(View v) {
        if (date1.equals("")) {
            ...
            Intent intent = new Intent(DateSelectorReg.this, CollegeActivity.class);
            Bundle bundle = new Bundle();
            bundle.putLong("Date1",epoch1);
            bundle.putLong("Date2",epoch2);
            bundle.putString("Collection",collection);
    ...
    public void select10(View v) {
        if (date1.equals("")) {
            ...
            Intent intent = new Intent(DateSelectorReg.this, SourceActivity.class);
            Bundle bundle = new Bundle();
            bundle.putLong("Date1",epoch1);
            bundle.putLong("Date2",epoch2);
            bundle.putString("Collection",collection);
    ...
    public void select11(View v) {
        if (date1.equals("")) {
            ...
            Intent intent = new Intent(DateSelectorReg.this, TLViewActivity.class);
            Bundle bundle = new Bundle();
            bundle.putLong("Date1",epoch1);
            bundle.putLong("Date2",epoch2);
            bundle.putString("Collection",collection);
    ...
    public void select12(View v) {
        if (date1.equals("")) {
            ...
            Intent intent = new Intent(DateSelectorReg.this, TimeActivity.class);
            Bundle bundle = new Bundle();
            bundle.putLong("Date1",epoch1);
            bundle.putLong("Date2",epoch2);
    ...
    public void select13(View v) {
        if (date1.equals("")) {
            ...
            Intent intent = new Intent(DateSelectorReg.this, ResActivity.class);
            Bundle bundle = new Bundle();
            bundle.putLong("Date1",epoch1);
            bundle.putLong("Date2",epoch2);
            bundle.putString("Date1Str",date1);
    ...
    public void select14(View v) {
        if (date1.equals("")) {
            ...
            Intent intent = new Intent(DateSelectorReg.this, UniqueActivity.class);
            Bundle bundle = new Bundle();
            bundle.putLong("Date1",epoch1);
            bundle.putLong("Date2",epoch2);
            bundle.putString("Date1Str",date1);
    ...
    public void select15(View v) {
        if (date1.equals("")) {
            ...
            Intent intent = new Intent(DateSelectorReg.this, TurnoutFGActivity.class);
            Bundle bundle = new Bundle();
            bundle.putLong("Date1",epoch1);
            bundle.putLong("Date2",epoch2);
            bundle.putString("Date1Str",date1);
    ...
    public void select16(View v) {
        if (date1.equals("")) {
            ...
            Intent intent = new Intent(DateSelectorReg.this, RegVsAttendedActivity.class);
            Bundle bundle = new Bundle();
            bundle.putLong("Date1",epoch1);
            bundle.putLong("Date2",epoch2);
            bundle.putString("Date1Str",date1);
    ...
    public void select17(View v) {
        if (date1.equals("")) {
            ...
            Intent intent = new Intent(DateSelectorReg.this, RegToAttendActivity.class);
            Bundle bundle = new Bundle();
            bundle.putLong("Date1",epoch1);
            bundle.putLong("Date2",epoch2);
            bundle.putString("Date1Str",date1);
